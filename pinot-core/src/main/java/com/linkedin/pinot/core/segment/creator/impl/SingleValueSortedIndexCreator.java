...
public class SingleValueSortedIndexCreator implements SingleValueForwardIndexCreator, Closeable {
  private FixedByteWidthRowColDataFileWriter indexWriter;
  private int[] mins;
  private int[] maxs;
  private int cardinality;

  public SingleValueSortedIndexCreator(File indexDir, int cardinality, FieldSpec spec) throws Exception {
